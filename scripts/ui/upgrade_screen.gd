...
func _update_ui() -> void:
	...
	health_button.disabled = SaveManager.gold < SaveManager.upgrade_cost or SaveManager.get_level(i, "max_health") >= 10
	speed_button.disabled = SaveManager.gold < SaveManager.upgrade_cost or SaveManager.get_level(i, "speed") >= 10
	luck_button.disabled = SaveManager.gold < SaveManager.upgrade_cost or SaveManager.get_level(i, "luck") >= 10
